...
//
// Nothing here decides anything: it renders a core.Snapshot and turns clicks
// into calls on a core.Controller. Keeping the logic on the other side of that
...
func headline(phase core.Phase) string {
	switch phase {
	case core.PhaseConnected:
		return "Connected"
	case core.PhaseConnecting:
		return "Connecting…"
	case core.PhaseDisconnecting:
		return "Disconnecting…"
	case core.PhaseAuthenticating:
...
func hint(snapshot core.Snapshot) string {
	...
	case core.PhaseConnected, core.PhaseConnecting, core.PhaseDisconnecting,
		core.PhaseDisconnected, core.PhaseUnknown:
		return ""
	default:
		return ""
	}
